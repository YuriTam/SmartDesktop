...
import com.smart.desktop.common.utils.PermissionUtils;
import com.smart.desktop.core.aop.annotation.Permission;
...
public class PermissionAspect {
     ...
     * @param permission
     */
    @Pointcut("execution(@com.smart.desktop.core.aop.annotation.Permission * *(..)) && @annotation(permission)")
