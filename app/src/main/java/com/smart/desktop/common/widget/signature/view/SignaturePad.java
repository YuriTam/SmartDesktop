package com.smart.desktop.common.widget.signature.view;
...
import com.smart.desktop.common.widget.signature.utils.Bezier;
import com.smart.desktop.common.widget.signature.utils.ControlTimedPoints;
import com.smart.desktop.common.widget.signature.utils.SvgBuilder;
import com.smart.desktop.common.widget.signature.utils.TimedPoint;
...
public class SignaturePad extends View {
    ...
    private final float DEFAULT_ATTR_PEN_TEXT_SIZE = 80f;
    ...
    private void ensureSignatureBitmap() {
        ...
        if (!TextUtils.isEmpty(mBlock) && isBlockChange) {
            Paint paint = new Paint();
            paint.setTextSize(DEFAULT_ATTR_PEN_TEXT_SIZE);
            paint.setTypeface(Typeface.SERIF);
            paint.setColor(Color.BLACK);
            int x = (getWidth() - getTextWidth(paint, mBlock)) / 2;
            int y = (getHeight() - getTextHeight(paint)) / 2;
            y = getBaseLine(paint, y);
            mSignatureBitmapCanvas.drawText(mBlock, x, y, paint);
            invalidate();
            isBlockChange = false;
        }
    }

    private int getBaseLine(Paint paint, int y) {
        Paint.FontMetrics fontMetrics = paint.getFontMetrics();
        return y + (int) ((getTextHeight(paint) - fontMetrics.bottom - fontMetrics.top) / 2);
    }
